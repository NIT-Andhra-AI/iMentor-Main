            ...
            <div className="max-w-5xl mx-auto pb-20">
                ...
                >
                    ...
                    <div className="flex items-center justify-center gap-3 mt-4">
                        <button
                            onClick={() => navigate('/gamification/skill-tree/generate')}
                            className="px-4 py-2 bg-zinc-900 hover:bg-zinc-800 border border-zinc-800 hover:border-zinc-600 rounded-xl text-zinc-300 text-sm transition-all flex items-center gap-2"
                        >
                            <svg className="w-4 h-4" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2"><path d="M12 3v19M19 12H5"/></svg>
